        ...
        const fetchData = async () => {
            try {
                ...
                if (balanceRes.ok && balanceData) {
                    ...
                    throw new Error(
                        balanceData.error || "Failed to fetch balance data"
                    );
                }
                ...
                if (!txRes.ok) {
                    ...
                    throw new Error(
                        `Failed to fetch transaction data: ${errorText}`
                    );
                }
                ...
                setTransactions(
                    txData.history_list.map((tx: any) => ({
                        ...tx,
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-8">
                                {[1, 2, 3, 4].map((i) => (
                                    <div
                                        key={i}
                                        className="h-4 w-20 bg-gray-200 rounded-full animate-pulse"
                                    />
                                ))}
                            </div>
                        </div>
                ...
                <div className="container mx-auto max-w-7xl px-4">
                    ...
                    <div className="space-y-4">
                        ...
                        <Card className="p-6">
                            ...
                            {data.chain_list.filter(
                                (chain) => chain.usd_value > 0
                            ).length === 0 && (
                                        ...
                                        {tokens
                                            ...
                                            .map((token) => {
                                                ...
                                                return (
                                                    <div
                                                        key={token.id}
                                                        className="flex items-center justify-between p-2 md:p-3 border rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700"
                                                    >
                                                        ...
                                                        <div className="text-right shrink-0">
                                                            ...
                                                            {priceChange !==
                                                                0 && (
                                                                <div
                                                                    className={`text-[10px] px-1.5 py-0.5 rounded-full font-medium inline-flex items-center ${
                                                                        priceChange >
                                                                        0
                                                                ...
                                                                <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4 text-sm">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div className="font-medium">
                                                                            {item.detail.supply_token_list.map(
                                                                                (
                                                                                    token,
                                                                                    i
                                                                                ) => (
                                                                    ...
                                                                    item.detail
                                                                        ...
                                                                        <div className="col-span-2 md:col-span-1">
                                                                            ...
                                                                            <div className="font-medium">
                                                                                {item.detail.reward_token_list.map(
                                                                                    (
                                                                                        token,
                                                                                        i
                                                                                    ) => (
                        ...
                        <Card className="p-4 md:p-6">
                            ...
                            <div className="space-y-2 md:space-y-4">
                                {transactions
                                    .filter((tx) => {
                                        const tokenId =
                                            tx.token_approve?.token_id;
                                        const tokenDict = tx.token_dict ?? {};
                                        return !tx.is_scam &&
                                            tokenId !== undefined
                                            ? !tokenDict[tokenId]?.is_scam
                                            : true;
                                    })
                                    .map((tx) => (
                                        <div
                                            key={tx.id}
                                            className="flex items-start md:items-center gap-3 p-2 md:p-3 border rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700"
                                        >
                                                    ...
                                                    {tx.sends?.map(
                                                        (send, i) => {
                                                            ...
                                                            return (
                                                                <div
                                                                    key={i}
                                                                    className="text-red-500 text-xs flex items-center justify-end gap-1 w-full"
                                                                >
                                                                    {token?.logo_url && (
                                                                        <Image
                                                                            src={
                                                    ...
                                                    {tx.receives?.map(
                                                        (receive, i) => {
                                                            ...
                                                            return (
                                                                <div
                                                                    key={i}
                                                                    className="text-green-500 text-xs flex items-center justify-end gap-1 w-full"
                                                                >
                                                                    {(token?.logo_url ||
                                                                        receive.token_id ===
                                                                            "base") && (
