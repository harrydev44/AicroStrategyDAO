                        ...
                        <div className="grid lg:grid-cols-2 gap-16 items-center">
                            ...
                            <div className="space-y-6">
                                ...
                                <p className="text-lg text-muted-foreground max-w-[90%] mt-6">
                                    AicroStrategy ($AiSTR) revolutionizes
                                    investment through autonomous AI agents,
                                    delivering unparalleled trading strategies
                                    on Base.
                                </p>
                        ...
                        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                            <Card className="p-6">
                                ...
                                <p className="mt-2 text-muted-foreground">
                                    Advanced AI algorithms to analyze market
                                    conditions and determine the optimal
                                    strategy.
                                </p>
                            </Card>
                            <Card className="p-6">
                                ...
                                <p className="mt-2 text-muted-foreground">
                                    Systematic approach to growing our treasury
                                    with cbBTC.
                                </p>
                            </Card>
                            <Card className="p-6">
                                ...
                                <p className="mt-2 text-muted-foreground">
                                    Multi-layered security protocols and dynamic
                                    position sizing to protect our holdings.
                                </p>
                            </Card>
                        </div>
                    </div>
                ...
                <AnimatedSection className="py-24 border-t">
                    <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        ...
                        <p className="mt-4 text-muted-foreground md:text-xl">
                            Leveraging advanced AI technology to maximize cbBTC
                            accumulation and optimize Bitcoin yields
                        </p>
                                    ...
                                    <div className="space-y-4">
                                        <div>
                                            ...
                                            <p className="text-muted-foreground">
                                                Utilizing cbBTC on Base for
                                                optimized Bitcoin exposure and
                                                strategic accumulation
                                            </p>
                                        </div>
                                        <div>
                                            ...
                                            <p className="text-muted-foreground">
                                                Systematic approach to growing
                                                our cbBTC holdings through
                                    ...
                                    <div className="grid gap-4">
                                        <div className="flex items-start space-x-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-muted-foreground">
                                                    Focused approach to maximize
                                                    cbBTC holdings through
                ...
                <AnimatedSection className="py-24 bg-background">
                    <div className="container mx-auto max-w-7xl px-4">
                        ...
                        <p className="text-lg text-muted-foreground">
                            Engage with other members of the AicroStrategy
                            community and stay informed about the latest
                            developments in AI-powered investment.
                        </p>
                    </div>
                </AnimatedSection>
